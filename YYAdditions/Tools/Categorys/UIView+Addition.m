...
- (NSIndexPath *)indexPathInTableView:(UITableView *)tableView{
    ...
    if (cell) {
        indexPath = [tableView indexPathForRowAtPoint:cell.center];
    }
...
+ (UIView *)lineViewWithLength:(CGFloat)length{
    UIView * lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, length, 1)];
    lineView.backgroundColor = [UIColor colorWithWhite:0.9375 alpha:1];
    return lineView;
}
